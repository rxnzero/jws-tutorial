    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            if (version.equals("1.1")) {
                ...
                QName faultName = 
                    new QName(SOAPConstants.URI_NS_SOAP_1_2_ENVELOPE, "Sender");
                fault.setFaultCode(faultName);
            }
            ...
            if (version.equals("1.1")) {
                ...
                fault.addFaultReasonText("Message does not have necessary info",
                    Locale.US);
            ...
            QName entryName2 = new QName("http://gizmos.com/confirm",
                "confirmation", "PO");
